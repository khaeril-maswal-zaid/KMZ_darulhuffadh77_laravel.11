            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="d-flex align-items-center mb-4 wow fadeIn" data-wow-delay="0.8s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-2">Tujuh-Tujuh, Kec. Kajuara</h5>
                            <h4 class="text-primary mb-0">Kab. Bone, Sulawesi Selatan</h4>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center mb-4 wow fadeIn" data-wow-delay="0.4s">
                        ...
                        <div class="ps-4">
                            ...
                            <h4 class="text-primary mb-0">Acq Darul Huffadh</h4>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-4 wow fadeIn" data-wow-delay="0.4s">
                        <div class="bg-primary d-flex align-items-center justify-content-center rounded"
                        ...
                        <div class="ps-4">
                            ...
                            <h4 class="text-primary mb-0">Darul Huffadh 77</h4>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-4 wow fadeIn" data-wow-delay="0.1s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-0">Kontak Pimpinan</h5>
                            <span class="mb-2">Ust. Saad Said</span>
                    ...
                    <div class="d-flex align-items-center mb-4 wow fadeIn" data-wow-delay="0.1s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-0">Kontak Direktur Putra</h5>
                            <span class="mb-2">Ust. Mustari Gaffar</span>
                            <h4 class="text-primary mb-0">+012 345 6789</h4>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-4 wow fadeIn" data-wow-delay="0.1s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-0">Kontak Direktur Putri</h5>
                            <span class="mb-2">Ust. Saddiyah Said</span>
                            <h4 class="text-primary mb-0">+012 345 6789</h4>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-4 wow fadeIn" data-wow-delay="0.1s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-0">Panitia PSB</h5>
                            <span class="mb-2">Ust. Saddiyah Said</span>
                            <h4 class="text-primary mb-0">+012 345 6789</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7 wow slideInUp bg-secondary" data-wow-delay="0.6s">
