    ...
    <div class="container-fluid pt-4 px-4">
        ...
        <div class="bg-light rounded h-100 p-4">
            @foreach ($penerimaans as $key => $penerimaan)
                <form action="{{ route('penerimaan.update', $penerimaan->sub) }}" method="post">
                    @csrf
                    <input type="hidden" name="content" id="valueconten{{ $key }}" value="Darul Huffadh 77 -bug">

                    <div class="card mb-3 border border-primary">
                        <div class="card-header bg-primary text-white">
                            <span class="d-inline text-white fs-5">{{ $penerimaan->sub }}</span>
                            ...
                            <div class="ck-editor">
                                ...
                                <div class="close">
                                    ...
                                    <script>
                                        ...
                                        CKEDITOR.ClassicEditor.create(document.getElementById("editor{{ $key }}"), {
                                            ...
                                            .then(editor => {
                                                const valPenerimaan = document.getElementById('valueconten{{ $key }}');
                                                valPenerimaan.value = editor.getData();
